...
ros::ServiceClient RobotInterface::client_get_pos;
ros::Publisher RobotInterface::publisher_set_vels;
...
bool RobotInterface::pid_calc_vels(float ret_vels[2])
{
...
void RobotInterface::goto_xy_pos(const int x, const int y)
{
  cmd_x_pos = x;
  cmd_y_pos = y;
