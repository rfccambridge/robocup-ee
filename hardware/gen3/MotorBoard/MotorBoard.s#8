...
<symbols>
<symbol name="A4931METTR-T">
<pin name="VBB" x="-20.32" y="27.94" length="middle" direction="pwr"/>
<pin name="VCP" x="-20.32" y="22.86" length="middle" direction="pas"/>
<pin name="DIR" x="-20.32" y="20.32" length="middle" direction="in"/>
<pin name="SENSE" x="-20.32" y="17.78" length="middle" direction="pas"/>
<pin name="BRAKEZ" x="-20.32" y="15.24" length="middle" direction="in"/>
<pin name="CLD" x="-20.32" y="10.16" length="middle" direction="pas"/>
<pin name="EN" x="-20.32" y="7.62" length="middle" direction="in"/>
<pin name="HA+" x="-20.32" y="2.54" length="middle" direction="in"/>
<pin name="HA-" x="-20.32" y="0" length="middle" direction="in"/>
<pin name="HB+" x="-20.32" y="-2.54" length="middle" direction="in"/>
<pin name="HB-" x="-20.32" y="-5.08" length="middle" direction="in"/>
<pin name="HC+" x="-20.32" y="-7.62" length="middle" direction="in"/>
<pin name="HC-" x="-20.32" y="-10.16" length="middle" direction="in"/>
<pin name="CP1" x="-20.32" y="-15.24" length="middle" direction="pas"/>
<pin name="CP2" x="-20.32" y="-17.78" length="middle" direction="pas"/>
<pin name="SA" x="-20.32" y="-22.86" length="middle" direction="pas"/>
<pin name="SB" x="-20.32" y="-25.4" length="middle" direction="pas"/>
<pin name="SC" x="-20.32" y="-27.94" length="middle" direction="pas"/>
<pin name="GND" x="-20.32" y="-33.02" length="middle" direction="pas"/>
<pin name="EPAD" x="-20.32" y="-35.56" length="middle" direction="pas"/>
<pin name="GLA" x="20.32" y="27.94" length="middle" direction="out" rot="R180"/>
<pin name="GLB" x="20.32" y="25.4" length="middle" direction="out" rot="R180"/>
<pin name="GLC" x="20.32" y="22.86" length="middle" direction="out" rot="R180"/>
<pin name="GHA" x="20.32" y="17.78" length="middle" direction="out" rot="R180"/>
<pin name="GHB" x="20.32" y="15.24" length="middle" direction="out" rot="R180"/>
<pin name="HBIAS" x="20.32" y="12.7" length="middle" direction="out" rot="R180"/>
<pin name="GHC" x="20.32" y="10.16" length="middle" direction="out" rot="R180"/>
<pin name="FG1" x="20.32" y="5.08" length="middle" direction="out" rot="R180"/>
<pin name="FG2" x="20.32" y="2.54" length="middle" direction="out" rot="R180"/>
...
<text x="-4.9784" y="36.1442" size="2.0828" layer="95" ratio="10" rot="SR0">&gt;NAME</text>
<text x="-3.7846" y="-44.8056" size="2.0828" layer="96" ratio="10" rot="SR0">&gt;VALUE</text>
</symbol>
</symbols>
<devicesets>
<deviceset name="A4931METTR-T" prefix="U">
<description>3-Phase Brushless DC Motor</description>
<gates>
<gate name="A" symbol="A4931METTR-T" x="0" y="0"/>
</gates>
<devices>
<device name="" package="QFN50P500X500X100-29N">
<connects>
<connect gate="A" pin="BRAKEZ" pad="28"/>
<connect gate="A" pin="CLD" pad="25"/>
<connect gate="A" pin="CP1" pad="9"/>
<connect gate="A" pin="CP2" pad="10"/>
<connect gate="A" pin="DIR" pad="26"/>
<connect gate="A" pin="EN" pad="27"/>
<connect gate="A" pin="EPAD" pad="29"/>
<connect gate="A" pin="FG1" pad="23"/>
<connect gate="A" pin="FG2" pad="24"/>
<connect gate="A" pin="GHA" pad="21"/>
<connect gate="A" pin="GHB" pad="19"/>
<connect gate="A" pin="GHC" pad="17"/>
<connect gate="A" pin="GLA" pad="16"/>
<connect gate="A" pin="GLB" pad="15"/>
<connect gate="A" pin="GLC" pad="14"/>
<connect gate="A" pin="GND" pad="7"/>
<connect gate="A" pin="HA+" pad="1"/>
<connect gate="A" pin="HA-" pad="2"/>
<connect gate="A" pin="HB+" pad="3"/>
<connect gate="A" pin="HB-" pad="4"/>
<connect gate="A" pin="HBIAS" pad="8"/>
<connect gate="A" pin="HC+" pad="5"/>
<connect gate="A" pin="HC-" pad="6"/>
<connect gate="A" pin="SA" pad="22"/>
<connect gate="A" pin="SB" pad="20"/>
<connect gate="A" pin="SC" pad="18"/>
<connect gate="A" pin="SENSE" pad="13"/>
<connect gate="A" pin="VBB" pad="11"/>
<connect gate="A" pin="VCP" pad="12"/>
</connects>
<technologies>
<technology name="">
<attribute name="MPN" value="A4931METTR-T" constant="no"/>
<attribute name="OC_FARNELL" value="1688964" constant="no"/>
<attribute name="OC_NEWARK" value="61M4134" constant="no"/>
<attribute name="PACKAGE" value="QFN-28" constant="no"/>
<attribute name="SUPPLIER" value="ALLEGRO MICROSYSTEMS" constant="no"/>
</technology>
</technologies>
</device>
</devices>
...
<part name="U1" library="Allegro_By_element14_Batch_1" deviceset="A4931METTR-T" device=""/>
<part name="U2" library="Allegro_By_element14_Batch_1" deviceset="A4931METTR-T" device=""/>
<part name="U3" library="Allegro_By_element14_Batch_1" deviceset="A4931METTR-T" device=""/>
<part name="U4" library="Allegro_By_element14_Batch_1" deviceset="A4931METTR-T" device=""/>
