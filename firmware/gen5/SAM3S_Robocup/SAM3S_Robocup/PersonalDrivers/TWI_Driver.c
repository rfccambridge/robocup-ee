...
void configure_io_expander (void) 
{
	...
	uint8_t io_dir_a[1] = {0x00};	// set direction of io pins on port A
	uint8_t io_dir_b[1] = {0x00};	// set direction of io pins on port B
	uint8_t ipol_a[1] = {0x00};		// polarity of gpio bit not inverted
	uint8_t ipol_b[1] = {0x00};		// polarity of gpio bit not inverted
	uint8_t gpinten_a[1] = {0x00};	// interrupts disabled
	uint8_t gpinten_b[1] = {0x00};	// interrupts disabled
	...
	uint8_t iocon_a[1] = {0x4e};	// see data sheet of MCP23017 for understanding of this register and the values set here
	uint8_t iocon_b[1] = {0x4e};	// see data sheet of MCP23017 for understanding of this register and the values set here
	...
	uint8_t gpio_a[1] = {0x55};		// input/output register
	uint8_t gpio_b[1] = {0x55};		// input/output register
